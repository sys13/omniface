...
describe('public API surface', () => {
  ...
  const SURFACE: Record<string, string[]> = {
    'packages/omniface/dist/index.d.ts': [
      ...
      'DEFAULT_EXPOSE_HEADERS', 'DEFAULT_METHODS', 'ERROR_CODES', 'Emit', 'EmittedEvent', 'ErrorCode', 'EventDefinition',
      'EventSink', 'EventsConfig', 'EventsProjection', 'EventsSettings', 'Facet', 'FacetAdapters', 'FacetChange',
      ...
      'ManifestAdapters', 'ManifestChange', 'ManifestDiff', 'ManifestEvent', 'ManifestOp', 'ManifestScreen', 'ManifestTool',
      ...
      'captureDefinitionSites', 'cliOf', 'cliSettings', 'createServer', 'createWebApp', 'declaredEvents', 'declaredScopes',
      'defineAuthAdapter', 'defineEvent', 'defineFacet', 'definePlugin', 'definitionSite', 'diffManifests',
      'enabledFacets', 'errors', 'escapeHtml', 'eventsOf', 'eventsSettings', 'exampleValue', 'facet', 'facetModule',
      'facetModules', 'formatDiff', 'getFieldTraits', 'hasTrait', 'humanLabel', 'inspectAll', 'inspectOp', 'isEvent',
      'isUntrusted', 'lint', 'mcpOf', 'mcpSettings', 'mcpTools', 'oauthChallenge',
